...
model_name="MindBrige_image_GIT_ViT_infonce_largemse"
...
--mse_mult $mse_mult --mae_mult $mae_mult --info_nce_mult $info_nce_mult --rec_mult $rec_mult --cyc_mult $cyc_mult \
