...
class Trainer_fmri_image:
    ...
    def train_step(self, voxel, image, subj_id, epoch):
        ...
        if self.args.info_nce_mult:
            loss_nce_image = utils.info_nce(fmri_image, git_feature_map, 0.1)
    ...
    def eval_step(self, voxel, image, subj_id, epoch):
        ...
        with torch.no_grad():
            ...
            # image mixco loss
            if self.args.info_nce_mult:
                val_loss_nce_image = utils.info_nce(fmri_image, git_feature_map, 0.1)
    ...
    def log_val(self):
        ...
        print(f"val/val_cosine_sim_image: {self.val_sims_image / (self.val_i + 1)}")
